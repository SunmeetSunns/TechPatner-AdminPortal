...
const ViewUserForm = ({ user, onSave, onCancel }) => {
  ...
  return (
    <div className="p-6 ml-64 bg-gray-900 min-h-screen text-white">
      ...
      <div className="mb-6">
        ...
        <h2 className="text-3xl font-bold mb-2">View User</h2>
        <p className="text-gray-400">View user information and settings</p>
      </div>
